...
def show_help():
    print('''
ffld2gmx.py [-h] [-n stem] [-f file.ffld] [-a file.ac]
...
(2nd column), in order to preserve the connectivities between region 2 and region 1 in state B.
...
Options:
 ...
 -n or --name  [stem name]    string used as prefix for atom types
...
def get_args():
    arg_list = sys.argv[1:]
    options="hn:f:a:"
    long_options=["help","name=","ffld=","ac="]
